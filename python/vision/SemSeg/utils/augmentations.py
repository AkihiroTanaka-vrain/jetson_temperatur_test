...
from vision.SemSeg.data import cfg, MEANS, STD
...
class Resize(object):
    ...
    def __init__(self, resize_gt=True, resize: Tuple[int, int] = (550, 550)):
...
class BaseTransform(object):
    ...
    def __init__(self, mean=MEANS, std=STD, resize: Tuple[int, int] = (550, 550)):
        self.augment = Compose([
            ConvertFromInts(),
            Resize(resize_gt=False, resize=resize),
...
class FastBaseTransform(torch.nn.Module):
    ...
    def __init__(self, use_cuda, resize: Tuple[int, int] = (550, 550)):
        super().__init__()
    ...
    def forward(self, img):
        ...
        img_size = (self.resize[1], self.resize[0])
