...
from vision.SemSeg.data.config import cfg, mask_type
from vision.SemSeg.layers import Detect
from vision.SemSeg.layers.interpolate import InterpolateModule
from vision.SemSeg.backbone import construct_backbone

import torch.backends.cudnn as cudnn
from vision.SemSeg.utils import timer
from vision.SemSeg.utils.functions import MovingAverage, make_net
...
class Yolact(nn.Module):
    ...
    def __init__(self):
        ...
        self.resize_target: Tuple[int, int] = (550, 550)
    ...
    def save_weights(self, path):
        ...
        state_dict['resize_target'] = torch.tensor(self.resize_target, dtype=torch.int32)
    ...
    def load_weights(self, path):
        ...
        if 'resize_target' in state_dict.keys():
            self.resize_target = (
                int(state_dict['resize_target'][0]),
                int(state_dict['resize_target'][1]),
            )
            del state_dict['resize_target']
        else:
            self.resize_target = (550, 550)
